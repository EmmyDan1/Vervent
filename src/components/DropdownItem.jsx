...
export default function DropdownItem({ item }) {
  return (
    <div className="flex w-[300px] items-start gap-3 border p-3 rounded-lg shadow-md hover:shadow-md hover:border-purple-400 transition duration-200 ease-in-out md:flex-col md:items-center md:gap-2">
